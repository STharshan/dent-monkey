...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Fast, efficient, friendly. Nicky does the job with a smile. Loads of nasty dents on my car Nicky sorted them no problem at all. Could not recommend him more! If you need any dents removing he’s the man to contact!",
    name: "BartekS",
  },
