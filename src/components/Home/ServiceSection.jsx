...
const services = [
  ...
  {
    title: "Large complex dents",
    desc: `Deep or extensive vehicle body damages that involve multiple curves.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Hail damage",
    desc: `Dents, dings, or cracks on a vehicle’s surface caused by the impact of hailstones during a storm.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[85%] mt-25 mx-auto h-15 object-cover"
                    onError={(e) => {
